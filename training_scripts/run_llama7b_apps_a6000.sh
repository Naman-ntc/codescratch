...
deepspeed code_trainer.py \
    ...
    --bf16 True \
    --tf32 True \
    --output_dir "checkpoints_codellama_7b_contests_${short_refactored_style}_${short_final_style}_2e5_256_${num_epochs}" \
    ...
    --block_size 2048 \
    --report_to wandb \
    --run_name "codellama_7b_remod_4e5_256_${num_epochs}" \
    --do_train \
    --do_eval \
